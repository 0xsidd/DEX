...
contract("TestUniswap", (accounts) => {
  ...
  const wethDaiWhale = '0x785e5354dB673118a980cEC5D2ED1cb5FC19cA83';
  ...
  beforeEach(async () => {
    CMPContract = new web3.eth.Contract(CMPAbi,CMPAddress);//await IERC20.at(TOKEN_IN);
    //DAIContract = new web3.eth.Contract(DAIAbi,DAIAddress);//await IERC20.at(TOKEN_OUT);
    testUniswap = await TestUniswap.new();
    conAddresss = await testUniswap.address;
    Value1 =  web3.utils.toWei('1', 'ether');
    Value = Value1.toString();
    app = await CMPContract.methods.approve(testUniswap.address, Value).send({from:wethDaiWhale});
    console.log("approved");
  });

  it("should pass", async () => {
    const tx = await testUniswap.weth(
